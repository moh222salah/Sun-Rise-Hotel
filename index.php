...
<html ng-app="AofWeb" lang="en" class="ng-scope">
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
				 ...
				 <i class="fa fa-clock-o" aria-hidden="true"></i>
					<h4>24 Hour Restaurant</h4>
					 ...
					 <p>debitis aut rerum necessitatibus saepe</p>
					 <p> eveniet ut et voluptates.</p>
					 <p><i class="fa fa-check" aria-hidden="true"></i>24 hours Restaurant service</p>
					...
					<p><i class="fa fa-" aria-hidden="true"></i></p>
			</div>
			 </div>
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
					 ...
					 <p><i class="fa fa-check" aria-hidden="true"></i>Decorated Room</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Address :</strong> New Cairo Road, Cairo, Egypt </p>
...
<div class="banner-top">
			...
			<div class="copy">
		        <p> 2019 SUNRISE . All Rights Reserved | Design by <a href="index.php">Mohamed Salah © </a> </p>
		    </div>
<!--/footer -->
<!-- js -->
